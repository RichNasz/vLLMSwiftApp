//
//  AlamoFireChatView.swift
//  vLLMSwiftApp
//
//  Created by Richard Naszcyniec on 6/20/25.
//

import SwiftData
import SwiftUI

/// View used to interact with vLLM using the [Alamofire](https://github.com/Alamofire/Alamofire) OSS project
///
...
struct AlamoFireChatView: View {
	...
	@StateObject private var chatManager: AlamoFireChatViewModel = .init()  // code for interacting with Alamofire
	...
	var body: some View {
		...
		.navigationTitle("Alamofire Chat")
